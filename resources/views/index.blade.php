...
<head>
    ...
    <title>ProBootstrap:Frame &mdash; Free Bootstrap Theme, Free HTML5 Template, Free Responsive Bootstrap Website Template</title>
...
{{--<link rel="stylesheet" href="../../../../Downloads/frame/css/styles-merged.css">--}}
{{--<link rel="stylesheet" href="../../../../Downloads/frame/css/style.min.css">--}}
{{--<link rel="stylesheet" href="../../../../Downloads/frame/fonts/icomoon/style.css">--}}

{!! Html::script('assets/js/vendor/html5shiv.min.js') !!}
{!! Html::script('assets/js/vendor/respond.min.js') !!}
<!--<script src="../../../../Downloads/frame/js/vendor/html5shiv.min.js"></script>-->
    <!--<script src="../../../../Downloads/frame/js/vendor/respond.min.js"></script>-->
</head>
<body>
...
<nav class="navbar navbar-default probootstrap-navbar">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/" title="ProBootstrap:Frame">Frame</a>
        </div>
    ...
    <div class="container">
        <div class="row intro-text">
            <div class="col-md-8 col-md-offset-2 text-center">
                <h1 class="probootstrap-heading probootstrap-animate">ProBootstrap.com Creates High Quality Bootstrap Template For
                    <em>Free</em></h1>
                <div class="probootstrap-subheading center">
                    <p class="probootstrap-animate">
                        <a href="https://probootstrap.com/" target="_blank" role="button" class="btn btn-primary">Get Them Now</a><a href="#features" class="btn btn-default smoothscroll" role="button">See Features</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row mb100">
            <div class="col-md-8 col-md-pull-2 probootstrap-animate">
                <p>
                    <img src="/img/img_showcase_1.jpg" alt="Free Template by ProBootstrap.com" class="img-responsive probootstrap-shadow">
                </p>
            </div>
            <div class="col-md-4 col-md-pull-1 probootstrap-section-heading">
                ...
                <p>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p></p>
        ...
        <div class="row mb100">
            ...
            <div class="col-md-8 col-md-push-5 probootstrap-animate">
                <p>
                    <img src="/img/img_showcase_2.jpg" alt="Free Template by ProBootstrap.com" class="img-responsive probootstrap-shadow">
                </p>
            </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="probootstrap-testimonial">
                    <p>
                        <img src="/img/person_1.jpg" class="img-responsive img-circle probootstrap-author-photo" alt="Free Template by ProBootstrap.com">
                    </p>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="probootstrap-testimonial">
                    <p>
                        <img src="/img/person_2.jpg" class="img-responsive img-circle probootstrap-author-photo" alt="Free Template by ProBootstrap.com">
                    </p>
                    <p class="mb10 probootstrap-rate">
                        <i class="icon-star"></i>
                        <i class="icon-star"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="probootstrap-testimonial">
                    <p>
                        <img src="/img/person_3.jpg" class="img-responsive img-circle probootstrap-author-photo" alt="Free Template by ProBootstrap.com">
                    </p>
                    <p class="mb10 probootstrap-rate">
                        <i class="icon-star"></i>
                        <i class="icon-star"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="probootstrap-testimonial">
                    <p>
                        <img src="/img/person_4.jpg" class="img-responsive img-circle probootstrap-author-photo" alt="Free Template by ProBootstrap.com">
                    </p>
                    <p class="mb10 probootstrap-rate">
                        <i class="icon-star"></i>
                        <i class="icon-star"></i>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12">
                        <p>
                            <img src="/img/laptop_1.jpg" alt="Free Template by ProBootstrap.com" class="img-responsive">
                        </p>
                    </div>
                </div>
                <div class="row">
...
<footer class="probootstrap-footer">
    <div class="container text-center">
        <div class="row">
            <div class="col-md-12">
                <p class="probootstrap-social"><a href="#"><i class="icon-twitter"></i></a>
        ...
        <div class="row">
            <div class="col-md-12">
                &copy; 2017 <a href="https://probootstrap.com/">ProBootstrap:Frame</a>. All Rights Reserved.
                <br> Designed &amp; Developed by <a href="https://probootstrap.com">ProBootstrap.com</a>
                <br> Demo Images by <a href="https://unsplash.com">Unsplash</a>
            </div>
        </div>
    </div>
</footer>
